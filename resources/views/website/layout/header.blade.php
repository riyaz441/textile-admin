        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse mean-menu">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a href="{{ route('index') }}" class="nav-link active">Home <i
                                    class='bx bx-chevron-down'></i></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a href="index.html" class="nav-link">Home 1</a></li>

                                <li class="nav-item"><a href="index-2.html" class="nav-link active">Home 2</a>
                                </li>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col">
                                                ...
                                                <ul class="megamenu-submenu">
                                                    <li><a href="products-left-sidebar.html">Left Sidebar</a>
                                                    </li>
                                                    ...
                                                    <li><a href="products-one-row.html">1 Products Per Row</a>
                                                    </li>

                                                    <li><a href="products-without-sidebar.html">Without
                                                            Sidebar</a></li>

                                                    <li><a href="products-sidebar-fullwidth.html">With Sidebar
                                                            Full Width</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <ul class="megamenu-submenu">
                                                    ...
                                                    <li><a href="products-right-sidebar-2.html">Right
                                                            Sidebar</a></li>

                                                    <li><a href="products-right-sidebar-with-categories-2.html">Right
                                                            Sidebar With Categories</a></li>

                                                    <li><a href="products-one-row-2.html">1 Products Per
                                                            Row</a></li>

                                                    <li><a href="products-without-sidebar-2.html">Without
                                                            Sidebar</a></li>

                                                    <li><a href="products-sidebar-fullwidth-2.html">With
                                            ...
                                            <div class="col">
                                                ...
                                                <ul class="megamenu-submenu">
                                                    ...
                                                    <li><a href="products-right-sidebar-3.html">Right
                                                            Sidebar</a></li>

                                                    <li><a href="products-right-sidebar-with-categories-3.html">Right
                                                            Sidebar With Categories</a></li>

                                                    <li><a href="products-one-row-3.html">1 Products Per
                                                            Row</a></li>

                                                    <li><a href="products-without-sidebar-3.html">Without
                                                            Sidebar</a></li>

                                                    <li><a href="products-sidebar-fullwidth-3.html">With
                                                            Sidebar Full Width</a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col">
                                                ...
                                                <ul class="megamenu-submenu">
                                                    ...
                                                    <li><a href="customer-service.html">Customer Service</a>
                                                    </li>
                                            ...
                                            <div class="col">
                                                ...
                                                <ul class="megamenu-submenu">
                                                    <li><a href="categories-1.html">Categories (2 in Row)</a>
                                                    </li>

                                                    <li><a href="categories-2.html">Categories Fullwidth</a>
                                                    </li>

                                                    <li><a href="categories-3.html">Categories (1 in Row)</a>
                                                    </li>
                                                ...
                                                <ul class="megamenu-submenu">
                                                    ...
                                                    <li><a href="lookbook-2.html">Grid Full Width (4 in
                                                            Row)</a></li>
                        ...
                        <li class="nav-item"><a href="#" class="nav-link">Blog <i
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a href="blog-3.html" class="nav-link">Grid (4 in
                                        Row)</a></li>

                                <li class="nav-item"><a href="blog-4.html" class="nav-link">Grid (Full
                                        Width)</a></li>
