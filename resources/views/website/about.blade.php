            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-12">
                    <div class="about-image">
                        <img src="{{ asset('website/assets/img/about/img1.jpg') }}" class="shadow" alt="image">
                        <img src="{{ asset('website/assets/img/about/img2.jpg') }}" class="shadow" alt="image">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="testimonials-slides owl-carousel owl-theme">
                <div class="single-testimonials-item">
                    ...
                    <div class="info">
                        <img src="{{ asset('website/assets/img/user1.jpg') }}" class="shadow rounded-circle" alt="image">
                        <h3>John Smith</h3>
                        <span>Student</span>
                    </div>
                </div>
                ...
                <div class="single-testimonials-item">
                    ...
                    <div class="info">
                        <img src="{{ asset('website/assets/img/user2.jpg') }}" class="shadow rounded-circle" alt="image">
                        <h3>Sarah Taylor</h3>
                        <span>Student</span>
                    </div>
                </div>
                ...
                <div class="single-testimonials-item">
                    ...
                    <div class="info">
                        <img src="{{ asset('website/assets/img/user3.jpg') }}" class="shadow rounded-circle" alt="image">
                        <h3>David Warner</h3>
                        <span>Student</span>
                    </div>
                </div>
                ...
                <div class="single-testimonials-item">
                    ...
                    <div class="info">
                        <img src="{{ asset('website/assets/img/user4.jpg') }}" class="shadow rounded-circle" alt="image">
