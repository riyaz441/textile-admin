...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            @if (($productsByCategory['male'] ?? collect())->isNotEmpty())
                                <li class="scroll-to-section"><a href="#men">Men's</a></li>
                            @endif
                            @if (($productsByCategory['female'] ?? collect())->isNotEmpty())
                                <li class="scroll-to-section"><a href="#women">Women's</a></li>
                            @endif
                            @if (($productsByCategory['kids'] ?? collect())->isNotEmpty())
                            ...
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ asset('website/assets/images/baner-right-image-01.jpg') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ asset('website/assets/images/baner-right-image-02.jpg') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ asset('website/assets/images/baner-right-image-03.jpg') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="right-first-image">
                                    <div class="thumb">
                                        ...
                                        <img src="{{ asset('website/assets/images/baner-right-image-04.jpg') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @php
        $categoryConfig = [
            'male' => [
                'id' => 'men',
                'title' => "Men's Latest",
                'carousel' => 'men-item-carousel',
                'owl' => 'owl-men-item',
            ],
            'female' => [
                'id' => 'women',
                'title' => "Women's Latest",
                'carousel' => 'women-item-carousel',
                'owl' => 'owl-women-item',
            ],
            'kids' => [
                'id' => 'kids',
                'title' => "Kid's Latest",
                'carousel' => 'kid-item-carousel',
                'owl' => 'owl-kid-item',
            ],
        ];
    @endphp
    ...
    @foreach ($categoryConfig as $category => $config)
        @php
            $categoryProducts = $productsByCategory[$category] ?? collect();
        @endphp
        @if ($categoryProducts->isNotEmpty())
            <section class="section" id="{{ $config['id'] }}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="{{ $config['carousel'] }}">
                                <div class="{{ $config['owl'] }} owl-carousel">
                                    @foreach ($categoryProducts as $product)
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="down-content">
                                                ...
                                                <ul class="stars">
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        <li><i class="fa {{ $i <= $starCount ? 'fa-star' : 'fa-star-o' }}"></i>
                                                        </li>
                                                    @endfor
                                                </ul>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="first-image">
                                    <img src="{{ asset('website/assets/images/explore-image-01.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="second-image">
                                    <img src="{{ asset('website/assets/images/explore-image-02.jpg') }}"
                                        alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
            ...
            <div class="row images">
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('website/assets/images/instagram-01.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('website/assets/images/instagram-02.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('website/assets/images/instagram-03.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('website/assets/images/instagram-04.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('website/assets/images/instagram-05.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('website/assets/images/instagram-06.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
