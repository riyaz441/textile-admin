$(document).ready(function () {
    ...
    // active and in active status changes start (labor)
    $(document).on('change', '.change_labor_status', function () {
        let dataId = $(this).data('id');
        let isChecked = $(this).is(':checked');
        let status = isChecked ? 'Active' : 'Inactive';
        $.ajax({
            url: APP_URL + '/change_labor_status',
            type: 'GET',
    ...
    // active and in active status changes end (labor)
});
