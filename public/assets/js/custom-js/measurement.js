$(document).ready(function () {
    // datatable js start
    new DataTable('#measurements-table', {
        layout: {},
        "ordering": false,
        oLanguage: {
            sLengthMenu: "_MENU_",
    ...
    // active and in active status changes end (measurement)
});
